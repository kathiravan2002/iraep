      ...
      <div className="text-justify ">
        ...
        <div >
          ...
          <div className='border-b-2 border-[#937D14] mb-4 space-y-3'>
            ...
            <div className='flex gap-3   lg:px-5 px-0 mb-4'><img src={icon} alt='icon' className='w-[22px] h-[20px]' /><p className='poppins-regular '>I/We will not publish the above-mentioned contribution anywhere else without the prior written permission of the publisher, unless it has been substantially changed.</p></div>

          </div>

          <div className='border-b-2 border-[#937D14] mb-4 space-y-3'>
            <h2 className='poppins-bold text-xl  text-[#937D14] text-center'>Content Warranty</h2>
            <div className='flex gap-3  lg:px-5 px-0 mb-4'><img src={icon} alt='icon' className='w-[22px] h-[20px]' /><p className='poppins-regular '>I/We declare and warrant that the contribution is original, except for excerpts from copyrighted works that may be included with the permission of the copyright holder and author thereof.</p></div>

          </div>
          <div className=' space-y-3'>
            <h2 className='poppins-bold text-xl  text-[#937D14] text-center'>Legal Compliance</h2>
            <div className='flex gap-3   lg:px-5 px-0 '><img src={icon} alt='icon' className='w-[22px] h-[20px]' /><p className='poppins-regular '>The Author warrants the right to enter into this Agreement and that the Article contains no libelous or unlawful statements, harmful instructions, and does not violate any rights or privacy of others.</p></div>
